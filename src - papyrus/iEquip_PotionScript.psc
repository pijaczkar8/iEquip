...
function createResistEffectsArrays()
    ...
    aiArmorSlots = new int[4]
    aiArmorSlots[0] = 0x00000001 ;Head
    aiArmorSlots[1] = 0x00000004 ;Body
    aiArmorSlots[2] = 0x00000008 ;Hands
    aiArmorSlots[3] = 0x00000080 ;Feet
...
function quickBuffGimmeStims()
    ...
    if PM.bQuickBuffCombatSkills
        ...
        if abQuickBuff[5] || abQuickBuff[6]
            int foundArmorType
            while i < 4
                foundArmorType = PlayerRef.GetEquippedArmorInSlot(aiArmorSlots[i]).GetWeightClass()
                if foundArmorType == 0
            ...
            if leftItemType == 10
                if PlayerRef.GetEquippedShield().GetWeightClass() == 0
                    lightArmorFound == true
                else
                    heavyArmorFound == true
                endIf
        ...
        bSuitableGearFound[2] = true ; Block - always true because you can block with pretty much anything
        if abQuickBuff[8]
