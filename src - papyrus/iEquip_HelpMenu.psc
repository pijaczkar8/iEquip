    ...
    while bShowAgain
        ...
        if iAction != 7             ; Exit
            if iAction == 0         ; Controls
                iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_controls1"))
                if iAction == 0
                    iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_controls2"))
                    if iAction == 0
                        iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_controls3"))
                        if iAction == 0
            ...
            elseif iAction == 1     ; Adding Items
                iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_addingItems1"))
                if iAction == 0
                    debug.MessageBox(iEquip_StringExt.LocalizeString("$iEquip_help_addingItems2"))
                endIf
            
            elseif iAction == 2     ; Ammo Mode
                iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_AmmoMode1"))
                if iAction == 0
                    debug.MessageBox(iEquip_StringExt.LocalizeString("$iEquip_help_AmmoMode2"))
                endIf
            
            elseif iAction == 3     ; Recharging
                iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_recharging1"))
                if iAction == 0
                    debug.MessageBox(iEquip_StringExt.LocalizeString("$iEquip_help_recharging2"))
                endIf
            
            elseif iAction == 4     ; Using Poisons
                iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_poisoning1"))
                if iAction == 0
    ...
    while bShowAgain
        ...
        if iAction  != 6            ; Exit
            ...
            elseif iAction == 1     ; Preselect
                iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_preselect1"))
                if iAction == 0
                    iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_preselect2"))
                    if iAction == 0
            ...
            elseif iAction == 3     ; QuickShield
                iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_quickshield1"))
                if iAction == 0
                    iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_quickshield2"))
                    if iAction == 0
            ...
            elseif iAction == 4     ; QuickHeal
                iAction = showHelpPage(iEquip_StringExt.LocalizeString("$iEquip_help_quickheal1"))
                if iAction == 0
